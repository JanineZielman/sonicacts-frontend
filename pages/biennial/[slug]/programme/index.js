...
export async function getServerSideProps({params}) {
  ...
  const [festivalRes, itemRes, globalRes, menusRes] = await Promise.all([
    ...
    fetchAPI(`/programmes?filters[biennial][slug][$eq]=${params.slug}&filters[biennials][slug][$ne]=biennial-2024&pagination[limit]=${100}&filters[main][$eq]=true&sort[0]=order%3Adesc&sort[1]=start_date%3Aasc&populate=*`),
