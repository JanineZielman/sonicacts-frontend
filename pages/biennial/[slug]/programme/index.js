...
export async function getServerSideProps({params}) {
  ...
  const [festivalRes, itemRes, globalRes, menusRes] = await Promise.all([
    ...
    fetchAPI(`/programmes?filters[biennial][slug][$eq]=${params.slug}&filters[$or][0][biennials][slug][$ne]=biennial-2024&filters[$or][1][biennials][slug][$null]=true&pagination[limit]=${100}&filters[main][$eq]=true&sort[0]=order%3Adesc&sort[1]=start_date%3Aasc&populate=*`),
