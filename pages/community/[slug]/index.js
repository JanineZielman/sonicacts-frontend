...
export async function getServerSideProps({params, query}) {
  ...
  const pageRes = 
    await fetchAPI( `/community-items?&filters[slug][$eq]=${params.slug}${preview ? "&publicationState=preview" : '&publicationState=live'}&populate[content][populate]=*&populate[links][populate]=*`
  );
