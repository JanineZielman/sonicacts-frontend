...
const DiscoverFiltered = ({ menus, global, page, categories}) => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      loader.add('https://cdn.curator.io/published/5e5a781d-0dba-4966-823a-29c0591ac51e.js'); 
