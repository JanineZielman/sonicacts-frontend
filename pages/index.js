...
export async function getServerSideProps() {
  ...
  const [homepageRes, globalRes, socialRes, menusRes, newsRes, agendaRes, discoverRes, communityRes, aboutRes] = await Promise.all([
    ...
    fetchAPI(`/community-items?filters[$or][0][biennials][slug][$ne]=biennial-2024&filters[$or][1][biennials][slug][$null]=true&sort[0]=id%3Adesc&pagination[pageSize]=6&populate=*`),
